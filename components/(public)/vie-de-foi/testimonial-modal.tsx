...
export const TestimonialModal = ({testimonial, isOpen, onClose}: TestimonialModalProps) => {
	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent
				className="p-4 sm:p-6 bg-background border-none shadow-xl max-h-screen overflow-y-auto aspect-square min-h-screen">
				<div className="flex flex-col items-center text-center space-y-6">
					...
					<DialogTitle asChild>
						<h2
							className="text-2xl border-b-1 py-2 w-full sm:text-3xl font-bold text-primary uppercase tracking-wide text-center">
							{testimonial.name}
						</h2>
					</DialogTitle>
